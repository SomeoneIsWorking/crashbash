...
- status: re-verified
- deps: boot.provision
- evidence: The verified USA image, residual measured targets, retail-derived HookEntryInt setjmp re-entry, and six measured CRASHBSH.DAT modules emit 1,470 roots into 2,698 functions: 1,355 resident, 710 BOOT, 89 MENU, 190 DAT28272, 106 DAT28241, 143 DAT28136, and 105 DAT28382. DAT28382's runtime-installed initializer 0x800BB370 is discovered from the whole image rather than added as a manual seed. The emitter fingerprints the exact emitted translation units and routing metadata as `recomp-2026-08-30.3-b1f83728a56e7affcade9963a670e4a7c1e63d89146926c628b6cbe170702f38`; tools/recomp_bootstrap.py binds that stamp to the compiled table, cache, and shipping RecompRegistry adapter and passes 10/10 positive/forced-negative checks. A Clang product build logs the same installed identity.
