...
- status: re-verified
- deps: boot.provision
- evidence: The verified USA image, residual measured targets, retail-derived HookEntryInt setjmp re-entry, and seven measured CRASHBSH.DAT modules emit 1,596 roots into 2,956 functions: 1,356 resident, 710 BOOT, 89 MENU, 190 DAT28272, 106 DAT28241, 143 DAT28136, 105 DAT28382, and 257 DAT22510. DAT28382's runtime-installed initializer 0x800BB370 and Polar Push's `0x800CBA64` callback are discovered from their whole images rather than added as guessed entry seeds. tools/recomp_bootstrap.py binds the emitted translation units, routing metadata, compiled table, cache, and shipping RecompRegistry adapter together; the real-input check passes after regenerating this substrate, and a Clang product build links its DAT22510 dispatch.
